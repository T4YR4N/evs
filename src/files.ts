...
export type ImagesFile = {
	...
	tag: string,
	digest: string,
	imagePath: `${string}/images/${string}/${string}_${string}_${string}.tar`
}[]
...
export type SbomsFile = (ImagesFile[number] & {
	sbomPath: `${string}/sboms/${string}/syft/${string}_${string}_${string}.sbom.json` | `${string}/sboms/${string}/trivy/${string}_${string}_${string}.sbom.json`
})[]
